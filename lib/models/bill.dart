...
/// due date is.
enum BillUrgency { paid, skipped, overdue, dueSoon, upcoming }
...
class BillInstance {
  ...
  /// Still owed this cycle. Never negative, even if the user overpaid.
  ...
  bool get isSettled =>
      status == BillStatus.paid || status == BillStatus.skipped;
